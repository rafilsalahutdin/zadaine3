...
- Обогащённый Excel-файл «Задачи» (добавлена колонка «Выполнено в срок») и «Свод» (агрегированные данные)

## 📁 Структура архива/репозитория

telegram-excel-bot/
├── README.md                 # Инструкция
├── workflow.json             # Экспорт n8n workflow (Рабочий файл)
...
- Проектирование структуры n8n workflow — оптимальная последовательность нод и способы передачи данных между ними.
